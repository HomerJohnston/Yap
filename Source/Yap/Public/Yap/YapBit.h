...
public:
	...
	TOptional<float> GetSpeechTime(UWorld* World, EYapTimeMode TimeMode, EYapLoadContext LoadContext, const UYapNodeConfig& Config) const;
...
protected:
	...
	TOptional<float> GetTextTime(const UYapNodeConfig& NodeConfig) const;
